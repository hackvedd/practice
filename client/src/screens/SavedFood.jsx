...
const videos = [
  {
    ...
    description: 'Delicious burger with fresh ingredients and homemade sauce.',
    foodPartner: '1',
  },

  {
    ...
    description: 'Tasty pizza with extra cheese and pepperoni toppings.',
    foodPartner: '2',
  },
];
...
const SavedFood = () => {
  ...
  useEffect(() => {
    axios
      .get(import.meta.env.VITE_BASE_URL + '/api/food/saved', {
